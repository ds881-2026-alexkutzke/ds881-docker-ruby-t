...
Este repositório contém o código-fonte de uma API REST de Calculadora desenvolvida em Ruby utilizando o framework Sinatra e o servidor Puma. As dependências externas estão mapeadas no arquivo Gemfile e devem ser instaladas através do gerenciador Bundler (bundle install) durante a construção da imagem. A aplicação expõe a porta 8080.
